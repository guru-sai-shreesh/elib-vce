...
import 'package:e_vce/screens/search_book/librarian/lib_recomendation/add_categeory.dart';
...
class LibRecomendationTab extends StatefulWidget {
  const LibRecomendationTab({Key? key}) : super(key: key);

  @override
  State<LibRecomendationTab> createState() => _LibRecomendationTabState();
}

class _LibRecomendationTabState extends State<LibRecomendationTab> {
  @override
