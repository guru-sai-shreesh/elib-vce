...
class _TrendingProjectTabState extends State<TrendingProjectTab> {
  @override
  List<bool> trendingProjectAlreadyClicked = <bool>[
    false,
    false,
    false,
    false,
                ...
                Container(
                  ...
                  child: Align(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        setState(() {
                          if (trendingProjectAlreadyClicked[index]) {
                            trendingProjectAlreadyClicked[index] = false;
                          } else {
                            trendingProjectAlreadyClicked[index] = true;
                          }
                        });
                      },
                      child: Icon(
                        trendingProjectAlreadyClicked[index]
                            ? Icons.favorite
                            : Icons.favorite_border,
                        color: trendingProjectAlreadyClicked[index]
                            ? Colors.red
                            : null,
                      ),
                    ),
